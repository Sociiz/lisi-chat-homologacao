...
.e-pivotview .e-grid .e-icons:hover {
  color: var(--color-sf-icon-color-hover) !important;
}
.e-pivotview .e-grid {
...
.e-pivotfieldlist-container.e-dialog .e-dlg-content ul li .e-text-content .e-checkbox-wrapper .e-frame.e-icons {
  margin: 0;
}
