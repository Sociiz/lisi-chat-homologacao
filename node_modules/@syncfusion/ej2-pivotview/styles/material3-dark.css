...
.e-pivotview .e-headercell:not(.e-columnsheader) {
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.05)), to(rgba(var(--color-sf-primary), 0.05))), rgba(var(--color-sf-surface)) !important;
...
.e-pivotfieldlist .e-select-table {
  ...
  top: 1px;
  /* stylelint-disable */
  background: -webkit-gradient(linear, left bottom, left top, from(rgba(var(--color-sf-primary), 0.12)), to(rgba(var(--color-sf-primary), 0.12))), rgba(var(--color-sf-surface)) !important;
